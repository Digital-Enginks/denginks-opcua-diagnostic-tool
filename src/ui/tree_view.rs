...
/// Tree view component for browsing OPC-UA nodes
...
impl<'a> TreeView<'a> {
    ...
    fn show_node(
        ...
        // Use a persistent ID for the collapsing state
        ...
        // Render logic with context menu
        if node.has_children {
            ...
            // Double-click on variables adds them to watchlist
